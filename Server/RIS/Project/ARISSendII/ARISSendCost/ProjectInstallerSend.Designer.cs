namespace ARISSend
{
	partial class ProjectInstallerSend
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.serviceInstallerSend.Description = "RISIF送信サービス(実施系)";
			this.serviceInstallerSend.DisplayName = "ARISSendCostService";
			this.serviceInstallerSend.ServiceName = "ARISSendCostService";
