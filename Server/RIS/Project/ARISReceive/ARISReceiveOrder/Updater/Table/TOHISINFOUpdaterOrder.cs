...
{
	internal class TOHISINFOUpdaterOrder : BaseUpdater
	{
		#region const
		...
		public override void SetParams(BaseMsgData data, System.Data.IDbCommand command)
		{
			...
			SetStringToCommand(PARAM_NAME_MESSAGEID1, orderData.KanjaID, command); //患者ID
			//SetStringToCommand(PARAM_NAME_MESSAGEID2, orderData.KanjaID, command); 
