...
{
	public partial class ReportInterfaceService : ServiceBase
	{
		#region field
		/// <summary>
		/// log4netインスタンス
		...
		/// サービス用ループクラス
		/// </summary>
		private ToReportInfoWatcher _watcher = new ToReportInfoWatcher();

		#endregion

		public ReportInterfaceService()
		{
			InitializeComponent();
		}
		...
		protected override void OnStart(string[] args)
		{
			...
			_watcher = new ToReportInfoWatcher();
