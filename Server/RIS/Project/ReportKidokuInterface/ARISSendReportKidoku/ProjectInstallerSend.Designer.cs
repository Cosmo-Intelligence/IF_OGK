namespace ARISSend
{
	partial class ProjectInstallerSend
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.serviceInstallerSend.Description = "RISIF送信サービス(受付系)";
			this.serviceInstallerSend.DisplayName = "ARISSendReportDokueiService";
			this.serviceInstallerSend.ServiceName = "ARISSendReportDokueiService";
