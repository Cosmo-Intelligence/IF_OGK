...
namespace StatisticsPrint.Model.Print.CDFilm.Data
{
	/// <summary>
	/// 検索結果保持クラス
	/// </summary>
	public class CDFilmItem : IHasDetailDayList
	{
		#region フィールド
		...
		/// アイテムリスト
		/// </summary>
		public List<CDFilmItemCDFilm> CDFilmItemList
		{
			get;
			set;
		}
		...
		public CDFilmItem()
		{
			CDFilmItemList = new List<CDFilmItemCDFilm>();
