...
namespace StatisticsPrint.Model.Print.BuiBunrui.Data
{
	...
	/// 検索結果保持クラス
	/// </summary>
	public class BuiBunruiItem : IHasDetailDayList
	{
		#region フィールド
		...
		/// アイテムリスト
		/// </summary>
		public List<BuiBunruiItemKensaType> KensaTypeItemList
		{
			get;
			set;
		}
		...
		/// コンストラクタ
		/// </summary>
		public BuiBunruiItem()
		{
			KensaTypeItemList = new List<BuiBunruiItemKensaType>();
