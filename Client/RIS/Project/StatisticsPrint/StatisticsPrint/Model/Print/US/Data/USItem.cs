...
namespace StatisticsPrint.Model.Print.US.Data
{
	...
	/// 検索結果保持クラス
	/// </summary>
	public class USItem : IHasDetailDayList
	{
		#region フィールド
		...
		public int Count
		{
			get
			{
				return USItemBunruiListUS.Count + USItemBunruiListDoppler.Count +
					USItemZoueizaiList.Count;
			}
		...
		/// US分類リスト
		/// </summary>
		public List<USItemBunrui> USItemBunruiListUS
		{
			get;
			set;
		}
		...
		/// ドップラ分類リスト
		/// </summary>
		public List<USItemBunrui> USItemBunruiListDoppler
		{
			get;
			set;
		}
		...
		/// 造影剤リスト
		/// </summary>
		public List<USItemKubun> USItemZoueizaiList
		{
			get;
			set;
		}
		...
		public USItem()
		{
			USItemBunruiListUS = new List<USItemBunrui>();
			USItemBunruiListDoppler = new List<USItemBunrui>();
			USItemZoueizaiList = new List<USItemKubun>();
