...
namespace StatisticsPrint.Model.Print.Emergency.Data
{
	/// <summary>
	/// 検索結果保持クラス
	/// </summary>
	public class EmergencyItem : IHasDetailDayList
	{
		#region フィールド
		...
		/// アイテムリスト
		/// </summary>
		public List<EmergencyItemEmergency> EmergencyItemList
		{
			get;
			set;
		}
		...
		{
			EmergencyItemList = new List<EmergencyItemEmergency>();
