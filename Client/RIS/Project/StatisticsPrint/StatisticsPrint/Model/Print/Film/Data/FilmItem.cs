...
namespace StatisticsPrint.Model.Print.Film.Data
{
	/// <summary>
	/// 検索結果保持クラス
	/// </summary>
	public class FilmItem : IHasDetailDayList
	{
		#region フィールド
		...
		/// フォルムリスト
		/// </summary>
		public List<FilmItemFilm> FilmItemList
		{
			get;
			set;
		}
		...
		public FilmItem()
		{
			FilmItemList = new List<FilmItemFilm>();
